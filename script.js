...
const playMusic = (track, pause = false) => {
    ...
    let cleanName = decodeURI(track).replace(/\\/g, " ");
...
async function main() {
    ...
    for (const song of songs) {
        songUL.innerHTML = songUL.innerHTML + `<li><img class="invert" src="music.svg" alt="music"><div class="info"><div>${song.replaceAll("%20", " ").replaceAll("%5C", " ")}</div><div>MS</div></div><div class="playnow"><span>Play Now</span><img class="invert" src="play.svg" alt="play"></div></li>
        </li>`;
    }
